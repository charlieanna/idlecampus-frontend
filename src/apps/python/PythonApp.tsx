...
export default function PythonApp() {
  ...
  const loadLabs = async () => {
    try {
      setLoading(true);
      const response = await apiService.fetchCodeLabs({ language: 'python' });
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-slate-600">Loading Python labs...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-80 border-r bg-slate-50 flex flex-col">
        <div className="p-4 border-b bg-blue-600 text-white">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-xl font-bold">Python Course</h1>
          </div>
          <p className="text-blue-100 text-sm">Master Python Programming</p>
          ...
          <div className="p-4 border-t bg-green-50">
            <div className="flex items-center gap-2 text-green-700">
              ...
              <div>
                ...
                <div className="text-xs">You've mastered all Python labs</div>
              </div>
            </div>
          </div>
        )}
