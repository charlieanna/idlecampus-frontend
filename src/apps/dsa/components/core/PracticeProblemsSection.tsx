...
export default function PracticeProblemsSection() {
    ...
    <div className="space-y-6 mt-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-2xl text-blue-900">Practice Problems</h2>
        </div>
        <p className="text-slate-700 text-base">
          Apply what you've learned to solve these LeetCode-style problems. Each problem tests your understanding of the backtracking pattern.
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-700">
              Start with <strong>Subsets</strong> since you just learned this pattern! 
              Then try <strong>Permutations</strong> (similar but no skipping), 
              and finally <strong>Combination Sum</strong> (elements can be reused).
            </p>
          </div>
        </div>
      </Card>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-slate-900">{problem.title}</h3>
