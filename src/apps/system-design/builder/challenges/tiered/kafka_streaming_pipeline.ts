/**
 * Generated Tiered Challenge: Kafka Streaming Pipeline
...
export const kafkaStreamingPipelineChallenge: Challenge = {
...
- Handle late-arriving data`,
  ...
  testCases: [
    {
      "name": "Ingest 1B events per day",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Ingest 1B events per day\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Process with exactly-once semantics",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Process with exactly-once semantics\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support stream joins and aggregations",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Support stream joins and aggregations\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Handle late-arriving data\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide real-time analytics",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Provide real-time analytics\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support event replay for reprocessing",
      "type": "functional",
      "requirement": "FR-6",
      "description": "Verify \"Support event replay for reprocessing\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
