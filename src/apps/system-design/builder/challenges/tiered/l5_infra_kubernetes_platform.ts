/**
 * Generated Tiered Challenge: Google Kubernetes Engine Architecture
...
export const l5InfraKubernetesPlatformChallenge: Challenge = {
...
- Provide multi-tenancy isolation`,
  ...
  testCases: [
    {
      "name": "Manage 100K Kubernetes clusters",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Manage 100K Kubernetes clusters\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support zero-downtime upgrades",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support zero-downtime upgrades\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable auto-scaling and auto-healing",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Enable auto-scaling and auto-healing\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide multi-tenancy isolation",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Provide multi-tenancy isolation\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support custom controllers",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support custom controllers\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
