/**
 * Generated Tiered Challenge: Zero-Knowledge Internet
...
export const l6PrivacyZkpInternetChallenge: Challenge = {
...
- Enable selective disclosure`,
  ...
  testCases: [
    {
      "name": "Generate ZK proofs for all requests",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Generate ZK proofs for all requests\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Verify proofs in milliseconds",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Verify proofs in milliseconds\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support recursive proof composition",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Support recursive proof composition\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable selective disclosure",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Enable selective disclosure\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Maintain auditability",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Maintain auditability\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
