/**
 * Generated Tiered Challenge: Salesforce Multi-Tenant CRM Platform
...
export const l5MultitenantSalesforceChallenge: Challenge = {
...
- Support custom workflows and triggers`,
  ...
  testCases: [
    {
      "name": "Support 100K tenant organizations",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Support 100K tenant organizations\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable custom fields and objects per tenant",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Enable custom fields and objects per tenant\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide tenant-specific API limits",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Provide tenant-specific API limits\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support custom workflows and triggers",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Support custom workflows and triggers\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable cross-tenant data sharing with consent",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Enable cross-tenant data sharing with consent\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
