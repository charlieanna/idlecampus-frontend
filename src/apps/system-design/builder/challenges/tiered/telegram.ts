/**
 * Generated Tiered Challenge: Telegram - Cloud Messaging
...
export const telegramChallenge: Challenge = {
  id: 'telegram',
...
4. Optimize for mobile networks (DDIA Ch. 4)
  ...
  testCases: [
    {
      "name": "Users can send messages, photos, and videos",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can send messages, photos, and videos\" works correctly. Must use object storage (S3) for files, not database.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5,
    ...
    {
      "name": "Users can create channels for broadcasting",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can create channels for broadcasting\" works correctly. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Read traffic of 2250 RPS exceeds single database capacity (~1000 RPS).\n**Why this test matters**: Single database instance has limited read capacity. High read traffic causes latency spikes and potential database overload.\n**How read replicas solve it**: Distribute read traffic across multiple replicas. Each replica handles ~1000 RPS, linearly scaling read capacity.\n**Pass criteria**: With 3 read replica(s), meet latency targets at acceptable cost. Without replicas: latency exceeds 200ms OR cost exceeds budget (vertical scaling is expensive).",
      "traffic": {
        "type": "read",
        "rps": 4500,
        "readRatio": 0.75
