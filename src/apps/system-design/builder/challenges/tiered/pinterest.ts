/**
 * Generated Tiered Challenge: Pinterest - Visual Bookmarking
...
export const pinterestChallenge: Challenge = {
  id: 'pinterest',
...
4. Handle high read volume with caching (SDP)
  ...
  testCases: [
    {
      "name": "Users can create boards and pin images",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can create boards and pin images\" works correctly. Must use object storage (S3) for files, not database. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3,
    ...
    {
      "name": "Users can browse and search for pins",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can browse and search for pins\" works correctly. Must have search index for efficient queries.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can follow boards and users",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Users can follow boards and users\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Images are organized into categories",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Images are organized into categories\" works correctly. Must use object storage (S3) for files, not database.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5,
