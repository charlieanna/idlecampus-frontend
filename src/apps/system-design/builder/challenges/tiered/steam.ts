/**
 * Generated Tiered Challenge: Steam - Gaming Platform
...
export const steamChallenge: Challenge = {
  id: 'steam',
...
- Users can add friends and view achievements`,
  ...
  testCases: [
    {
      "name": "Users can browse and purchase games",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can browse and purchase games\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can download and launch games",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can download and launch games\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can add friends and view achievements",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Users can add friends and view achievements\" works correctly. Should cache reads to reduce database load. Test flow: Client → [Cache] → App → Database.",
      "traffic": {
        "type": "read",
        "rps": 100,
        "readRatio": 0.9
