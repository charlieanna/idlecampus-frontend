/**
 * Generated Tiered Challenge: 6G Network Architecture
...
export const l6Protocol6gArchitectureChallenge: Challenge = {
...
- Provide ubiquitous coverage including space`,
  ...
  testCases: [
    {
      "name": "Achieve 1Tbps peak data rates",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Achieve 1Tbps peak data rates\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support holographic communication",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support holographic communication\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable AI-native network operations",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Enable AI-native network operations\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide ubiquitous coverage including space",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Provide ubiquitous coverage including space\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support 10M devices per km²",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support 10M devices per km²\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
