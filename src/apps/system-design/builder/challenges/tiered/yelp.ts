/**
 * Generated Tiered Challenge: Yelp - Business Reviews
...
export const yelpChallenge: Challenge = {
  id: 'yelp',
...
4. Partition by geography for horizontal scaling (DDIA Ch. 6)
  ...
  testCases: [
    {
      "name": "Users can search for local businesses",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can search for local businesses\" works correctly. Must have search index for efficient queries.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can write reviews and upload photos",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can write reviews and upload photos\" works correctly. Must use object storage (S3) for files, not database. Should cache reads to reduce database load. Test flow: Client → [Cache] → App → Database.",
      "traffic": {
        "type": "read",
        "rps": 100,
        "readRatio": 0.9,
    ...
    {
      "name": "Businesses are ranked by rating and relevance",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Businesses are ranked by rating and relevance\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Platform supports geospatial search",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Platform supports geospatial search\" works correctly. Must have search index for efficient queries.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
