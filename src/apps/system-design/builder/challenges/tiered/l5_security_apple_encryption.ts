/**
 * Generated Tiered Challenge: Apple End-to-End Encryption Platform
...
export const l5SecurityAppleEncryptionChallenge: Challenge = {
...
- Provide legal compliance mechanisms`,
  ...
  testCases: [
    {
      "name": "Encrypt all user data end-to-end",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Encrypt all user data end-to-end\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support multi-device synchronization",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support multi-device synchronization\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable account recovery without Apple access",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Enable account recovery without Apple access\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide legal compliance mechanisms",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Provide legal compliance mechanisms\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support 1B active devices",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support 1B active devices\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
