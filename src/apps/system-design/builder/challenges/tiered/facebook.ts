/**
 * Generated Tiered Challenge: Facebook - Social Network
...
export const facebookChallenge: Challenge = {
  id: 'facebook',
...
4. Denormalize for performance (DDIA Ch. 3)
  ...
  testCases: [
    {
      "name": "Users can create profiles and friend other users",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can create profiles and friend other users\" works correctly. Must use object storage (S3) for files, not database. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3,
    ...
    {
      "name": "Users can post status updates, photos, and videos",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can post status updates, photos, and videos\" works correctly. Must use object storage (S3) for files, not database. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3,
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \" posts\" works correctly. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3
    ...
    {
      "name": "Users can like and comment on posts",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Users can like and comment on posts\" works correctly. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Traffic increases during peak hours (evening social browsing).\nSystem must maintain acceptable latency with 2x traffic. Slight degradation OK but system must stay up.",
      "traffic": {
        "type": "read",
        "rps": 20000,
        "readRatio": 0.9,
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Read traffic of 9000 RPS exceeds single database capacity (~1000 RPS).\n**Why this test matters**: Single database instance has limited read capacity. High read traffic causes latency spikes and potential database overload.\n**How read replicas solve it**: Distribute read traffic across multiple replicas. Each replica handles ~1000 RPS, linearly scaling read capacity.\n**Pass criteria**: With 9 read replica(s), meet latency targets at acceptable cost. Without replicas: latency exceeds 400ms OR cost exceeds budget (vertical scaling is expensive).",
      "traffic": {
        "type": "read",
        "rps": 15000,
        "readRatio": 0.9,
  ...
  components: [
    ...
    },
    {
      ...
      config: {
        ...
        subtitle: "Writes + 4 replicas (reads)"
      }
    },
    {
      type: "cdn",
