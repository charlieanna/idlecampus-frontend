/**
 * Generated Tiered Challenge: Beyond CAP Theorem Database
...
export const l6DbCapTheoremBreakerChallenge: Challenge = {
...
- Support global transactions`,
  ...
  testCases: [
    {
      "name": "Maintain consistency during partitions",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Maintain consistency during partitions\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide 100% availability",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Provide 100% availability\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Tolerate arbitrary network failures",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Tolerate arbitrary network failures\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support global transactions",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Support global transactions\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable time-travel queries",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Enable time-travel queries\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
