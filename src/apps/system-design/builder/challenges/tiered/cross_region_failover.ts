/**
 * Generated Tiered Challenge: E-commerce Platform with Disaster Recovery
...
export const crossRegionFailoverChallenge: Challenge = {
...
- Data replication and backup strategies`,
  ...
  testCases: [
    {
      "name": "Health checks per region",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Health checks per region\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Automatic DNS failover",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Automatic DNS failover\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Async data replication",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Async data replication\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"RPO < 5 minutes\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"RTO < 10 minutes\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
