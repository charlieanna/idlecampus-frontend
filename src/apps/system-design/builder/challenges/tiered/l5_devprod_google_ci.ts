/**
 * Generated Tiered Challenge: Google Monorepo CI/CD System
...
export const l5DevprodGoogleCiChallenge: Challenge = {
...
- Enable incremental builds`,
  ...
  testCases: [
    {
      "name": "Handle 100K commits daily",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Handle 100K commits daily\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Run 100M tests per day",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Run 100M tests per day\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support 5000 deployments daily",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Support 5000 deployments daily\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Enable incremental builds\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide < 10 minute feedback",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Provide < 10 minute feedback\" works correctly. Should cache reads to reduce database load. Test flow: Client → [Cache] → App → Database.",
      "traffic": {
        "type": "read",
        "rps": 100,
        "readRatio": 0.9
