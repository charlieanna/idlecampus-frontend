/**
 * Generated Tiered Challenge: Post-TCP Protocol for Exascale
...
export const l6ProtocolTcpReplacementChallenge: Challenge = {
...
- Support multipath by default`,
  ...
  testCases: [
    {
      "name": "Support 400Gbps+ per connection",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Support 400Gbps+ per connection\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable one-sided RDMA operations",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Enable one-sided RDMA operations\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Handle persistent memory semantics",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Handle persistent memory semantics\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support multipath by default",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Support multipath by default\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Integrate with quantum channels",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Integrate with quantum channels\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
