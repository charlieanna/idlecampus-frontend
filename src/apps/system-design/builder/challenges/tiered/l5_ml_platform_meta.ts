/**
 * Generated Tiered Challenge: Meta ML Training Platform
...
export const l5MlPlatformMetaChallenge: Challenge = {
...
- Provide experiment tracking and versioning`,
  ...
  testCases: [
    {
      "name": "Train 1000+ models concurrently",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Train 1000+ models concurrently\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support distributed training on 10K GPUs",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support distributed training on 10K GPUs\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable automatic hyperparameter tuning",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Enable automatic hyperparameter tuning\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide experiment tracking and versioning",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Provide experiment tracking and versioning\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support online learning pipelines",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support online learning pipelines\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
