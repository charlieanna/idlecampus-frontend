/**
 * Generated Tiered Challenge: DataDog-Scale Observability Platform
...
export const l5ObservabilityDatadogChallenge: Challenge = {
...
- Enable complex query language`,
  ...
  testCases: [
    {
      "name": "Ingest 10T data points daily",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Ingest 10T data points daily\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support 1M custom metrics",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support 1M custom metrics\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Provide < 1 minute data latency",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Provide < 1 minute data latency\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable complex query language",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Enable complex query language\" works correctly. Must have search index for efficient queries.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support 100K dashboards",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support 100K dashboards\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
