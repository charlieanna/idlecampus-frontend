/**
 * Generated Tiered Challenge: Hulu - TV & Movie Streaming
...
export const huluChallenge: Challenge = {
  id: 'hulu',
...
- Content is available with or without ads`,
  ...
  testCases: [
    {
      "name": "Users can watch TV shows and movies",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can watch TV shows and movies\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can record shows to watch later (DVR)",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can record shows to watch later (DVR)\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
  ...
  referenceLinks: [
  {
    "label": "Hulu Tech Blog",
    "url": "https://medium.com/hulu-tech-blog"
  },
  {
    "label": "Official Site",
