/**
 * Generated Tiered Challenge: Netflix GraphQL Federation Platform
...
export const l5ApiGraphqlFederationChallenge: Challenge = {
...
- Enable field-level caching`,
  ...
  testCases: [
    {
      "name": "Federate 1000 service schemas",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Federate 1000 service schemas\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Optimize query execution plans",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Optimize query execution plans\" works correctly. Must have search index for efficient queries.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support real-time subscriptions",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Support real-time subscriptions\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable field-level caching",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Enable field-level caching\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Handle partial failures gracefully",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Handle partial failures gracefully\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
