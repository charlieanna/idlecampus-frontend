/**
 * Generated Tiered Challenge: Uber Real-Time Data Platform
...
export const l5DataPlatformUberChallenge: Challenge = {
...
- Compute ML features in real-time`,
  ...
  testCases: [
    {
      "name": "Ingest 1 trillion events daily",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Ingest 1 trillion events daily\" works correctly. Should process asynchronously using message queue.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support sub-minute data freshness",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Support sub-minute data freshness\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Enable SQL queries on streaming data",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Enable SQL queries on streaming data\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Compute ML features in real-time",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Compute ML features in real-time\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Support time-travel queries",
      "type": "functional",
      "requirement": "FR-5",
      "description": "Verify \"Support time-travel queries\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
