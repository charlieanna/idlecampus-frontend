/**
 * Generated Tiered Challenge: GitHub - Code Hosting
...
export const githubChallenge: Challenge = {
  id: 'github',
...
9. Compare derived views vs distributed transactions (DDIA Ch. 12)
  ...
  testCases: [
    {
      "name": "Users can host Git repositories",
      "type": "functional",
      "requirement": "FR-1",
      "description": "Verify \"Users can host Git repositories\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Users can create pull requests and issues",
      "type": "functional",
      "requirement": "FR-2",
      "description": "Verify \"Users can create pull requests and issues\" works correctly. Test flow: Client → App → Database.",
      "traffic": {
        "type": "write",
        "rps": 50,
        "readRatio": 0.3
    ...
    {
      "name": "Users can fork and star repositories",
      "type": "functional",
      "requirement": "FR-3",
      "description": "Verify \"Users can fork and star repositories\" works correctly.",
      "traffic": {
        "type": "mixed",
        "rps": 10,
        "readRatio": 0.5
    ...
    {
      "name": "Platform supports code review and collaboration",
      "type": "functional",
      "requirement": "FR-4",
      "description": "Verify \"Platform supports code review and collaboration\" works correctly. Should cache reads to reduce database load. Test flow: Client → [Cache] → App → Database.",
      "traffic": {
        "type": "read",
        "rps": 100,
        "readRatio": 0.9
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Traffic increases during peak hours (end-of-sprint pushes).\nSystem must maintain acceptable latency with 2x traffic. Slight degradation OK but system must stay up.",
      "traffic": {
        "type": "read",
        "rps": 4000,
        "readRatio": 0.9
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Major security vulnerability announced causes sudden 50% traffic increase.\nSystem must handle spike gracefully without complete failure.",
      "traffic": {
        "type": "read",
        "rps": 3000,
        "readRatio": 0.9
    ...
    },
    {
      ...
      "type": "functional",
      "requirement": "FR-1",
      "description": "Open source project explodes in popularity - traffic triples!\nThis tests if architecture can scale horizontally. May require load balancers and multiple servers.",
      "traffic": {
        "type": "read",
        "rps": 6000,
        "readRatio": 0.9
